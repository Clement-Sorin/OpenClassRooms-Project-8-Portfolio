...
function Landing() {
    ...
    return (
        <section
            onWheel={handleWheel}
            id="landing"
            className={`absolute h-screen sm:top-3 md:top-[70px] w-full bg-gradient-to-tr from-light-grey to-gradient+ dark:bg-gradient-to-tr dark:from-dark-blue dark:to-dark-gradient+ snap-start`}
        >
            <Particles className={` particles top-0`} />
            <div className="content-landing fixed sm:top-3 md:top-[80px] h-screen mw-auto flex-col justify-center pb-24">
